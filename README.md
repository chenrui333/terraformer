...
6.  Support Terraform CLI 1.9 through 1.14.
...
Terraformer writes Terraform 1.x-compatible provider source addresses into generated state.
For state generated by older Terraformer releases, you can use `replace-provider` to migrate state from previous versions.
...
* Better support for Terraform 1.x-compatible HCL + tfstate.
...
Terraformer is primarily licensed under Apache-2.0.
