...
func TestSelectImportResourceName(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:    "falls back to manifest for pod certificate request",
			group:   "certificates.k8s.io",
			version: "v1beta1",
			resource: metav1.APIResource{
		...
		{
			name:    "falls back to manifest for alpha pod certificate request",
			group:   "certificates.k8s.io",
			version: "v1alpha1",
			resource: metav1.APIResource{
				Name:       "podcertificaterequests",
...
func TestSupportsNativeManifestResource(t *testing.T) {
	tests := []struct {
		...
		{name: "pod certificate request beta", group: "certificates.k8s.io", version: "v1beta1", kind: "PodCertificateRequest", want: true},
		{name: "pod certificate request alpha", group: "certificates.k8s.io", version: "v1alpha1", kind: "PodCertificateRequest", want: true},
