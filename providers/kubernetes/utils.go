...
var nativeManifestResources = map[kubernetesResourceID]struct{}{
	...
	{group: "resource.k8s.io", version: "v1beta1", kind: "DeviceClass"}:                                    {},
